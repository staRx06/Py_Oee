...
def update_charts(value, start_date, end_date):
    ...
    if value == ["AVAILABILITY"]:
        coluu = data.AVAILABILITY
        # for i in np.sort(data.AVAILABILITY):
        #     coluu.append(i)
    elif value == ["PERFORMANCE"]:
        coluu = data.PERFORMANCE
        # for j in np.sort(data.PERFORMANCE):
        #     coluu.append(j)
    elif value == ["QUALITY"]:
        coluu = data.QUALITY
        # for k in np.sort(data.QUALITY):
        #     coluu.append(k)
    elif value == ["OEE"]:
        coluu = data.OEE
        # for l in np.sort(data.OEE):
        #     coluu.append(l)
